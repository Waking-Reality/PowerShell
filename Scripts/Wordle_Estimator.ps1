...
Write-Host "and enter them at the following prompts. If there is a green letter, enter that at the prompt. Enter "
Write-Host "all of the remaining letters in the other prompts except for the orange letters in that column. You  "
Write-Host "may copy from the lines above and edit them as needed for the remaining inputs.                      "
Write-Host ""
